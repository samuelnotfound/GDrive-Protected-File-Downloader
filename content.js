(() => {
  ...
  function addProtectedDownloadMenuItem() {
    ...
    for (const menu of menus) {
      ...
      info.textContent = "When a PDF is view-only, regular downloading is disabled. This option works around that limitation by capturing each page in high resolution and automatically combining them into a downloadable PDF.";
